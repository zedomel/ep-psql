...
public class LampJBlas {
	...
	public DoubleMatrix project(DoubleMatrix x, DoubleMatrix xs, DoubleMatrix ys){
		...
		for (int pt = 0; pt < ninst; pt++){
			...
			DoubleMatrix m = A.transpose().mmul(B);
			DoubleMatrix[] udv = Singular.fullSVD( m );
	...
	public static void main(String[] args) throws IOException {
		...
		DoubleMatrix ys = new DoubleMatrix(new double[][]{
